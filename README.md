...
Or alternatively, you can also use the precompiled version too! Great for Windows Weebs, that just want to run without having to install python and the required libraries, or lazy Debian users.
